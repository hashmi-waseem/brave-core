...
extension Strings {
  ...
  public static let syncDeprecatedVersionError = NSLocalizedString(
    ...
    tableName: "BraveShared",
    bundle: .module,
    value: "It looks like this code was created on a device running an older version of Brave. Please update to the latest version of Brave on your other device, and then create a new sync code.",
    comment: "Sync Error Description"
  )
